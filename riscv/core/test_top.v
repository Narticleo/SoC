...
wire                    ctrl_branch_fail_flush_jump_o;
wire                    ctrl_succes_fail_flush_jump_o;
...
pipe_ctrl ctrl0(
    ...
    .jump_addr_pred_i(id_jump_addr_o), // prediction addr
    .is_jump_i(id_is_jump_o),// prediction enable

    .stall_o(ctrl_stall_o),
    .flush_jump_o(ctrl_flush_jump_o),
    .new_pc_o(ctrl_new_pc_o),
    .branch_fail_flush_jump_o(ctrl_branch_fail_flush_jump_o)
    .branch_succes_flush_jump_o(ctrl_succes_fail_flush_jump_o)
);
...
if_id if_id0(
    ...
    .stall_i(ctrl_stall_o),
    .flush_jump_i(ctrl_flush_jump_o),
    .branch_fail_flush_i(ctrl_branch_fail_flush_jump_o),
    //to id
...
wire                        id_reg1_re_o;
wire                        id_reg2_re_o;
// id to ctrl branch predtion 
wire[`ADDR_WIDTH-1:0]       id_jump_addr_o;
wire id_is_jump_o;
// 連接 id 與 id_exe線
...
id id0(
    ...
    .jump_addr_pred_o(id_jump_addr_o),
...
id_exe id_exe0(
    ...
    .stall_i(ctrl_stall_o),
    .flush_jump_i(ctrl_flush_jump_o),
    .branch_succes_flush_i(ctrl_succes_fail_flush_jump_o),
