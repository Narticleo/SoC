...
module id(
    ...
    output reg[`ADDR_WIDTH-1:0] jump_addr_pred_o,
        ...
        if (rst_i) begin
            ...
            case (opcode)
                ...
                `INST_TYPE_B:begin
                    ...
                    op2_o_final = reg2_rdata_i;
                    reg_we_o = `WRITE_DISABLE;
                    jump_addr_pred_o = pc + b_imm; //to ctrl for branch predi
                    is_jump_o = 1'b1;
                ...
                `INST_TYPE_JAL:begin
                    ...
                    reg_we_o = `WRITE_ENABLE;
                    reg_waddr_o = rd;
                    jump_addr_pred_o = pc + jal_imm;//to ctrl for branch predi
                    is_jump_o = 1'b1;
